              ...
              <div className="space-y-2">
                ...
                <div className="mt-3 pt-3 border-t border-blue-200">
                  ...
                  <div className="text-xs text-gray-600">
                    Real-time traffic predictions powered by machine learning
                    are being generated for 8 route segments. Colors indicate:
                    🟢 Light, 🟡 Moderate, 🟠 Medium, 🔴 Heavy traffic.
                  </div>
                  <div className="mt-2 text-xs text-purple-600 font-medium">
                    ⚡ Live predictions updating based on current conditions
                  </div>
                </div>
                <button
